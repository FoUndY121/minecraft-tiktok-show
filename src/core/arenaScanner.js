...
// Keep this list in sync with resource-pack / country block mapping.
...
async function scanArenaForFlagBlocks({ bot, arena }) {
	...
	const x1 = a.origin.x
	const x2 = a.origin.x + a.maxWidth - 1
	const z1 = a.origin.z
	const z2 = a.origin.z + a.maxDepth - 1

	const y1 = a.origin.y - 5
	const y2 = a.origin.y + a.maxStack * a.maxHeight + 30
